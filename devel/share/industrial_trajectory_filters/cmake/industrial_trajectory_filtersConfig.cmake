...
if("TRUE" STREQUAL "TRUE")
  set(industrial_trajectory_filters_SOURCE_PREFIX /home/etudiant/yaskawa2/src/industrial_core/industrial_trajectory_filters)
  set(industrial_trajectory_filters_DEVEL_PREFIX /home/etudiant/yaskawa2/devel)
  ...
  set(industrial_trajectory_filters_INSTALL_PREFIX /home/etudiant/yaskawa2/install)
...
if(NOT "/home/etudiant/yaskawa2/src/industrial_core/industrial_trajectory_filters/include " STREQUAL " ")
  set(industrial_trajectory_filters_INCLUDE_DIRS "")
  set(_include_dirs "/home/etudiant/yaskawa2/src/industrial_core/industrial_trajectory_filters/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'industrial_trajectory_filters' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/etudiant/yaskawa2/src/industrial_core/industrial_trajectory_filters/${idir}'.  ${_report}")
    endif()
